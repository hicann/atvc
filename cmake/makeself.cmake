...
execute_process(
  COMMAND python3 ${CPACK_CMAKE_SOURCE_DIR}/scripts/package/package.py --pkg_name atvc --os_arch linux.${CPACK_ARCH}
...
set(ATVC_VERSION_OUT_PUT
  ${CPACK_CMAKE_BINARY_DIR}/atvc_version.h
)
...
configure_file(
  ${CSV_OUTPUT}
  ${STAGING_DIR}/atvc/script
  COPYONLY
)
configure_file(
  ${ATVC_VERSION_OUT_PUT}
  ${STAGING_DIR}/atvc/
  COPYONLY
)
# makeself打包
...
execute_process(COMMAND bash ${MAKESELF_EXE}
  ...
  --help-header atvc/script/help.info
  ${makeself_param_string} atvc/script/install.sh
