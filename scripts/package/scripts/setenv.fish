...
function get_install_param
    ...
    set -l install_info_key_array Atvc_Install_Type Atvc_Feature_Type Atvc_UserName Atvc_UserGroup Atvc_Install_Path_Param Atvc_Arch_Linux_Path Atvc_Hetero_Arch_Flag
...
function get_install_dir
    ...
    set -l hetero_arch (get_install_param "Atvc_Hetero_Arch_Flag" "$install_info")
