...
# Copy ATVC host and kernel implementation files to CustomOp
cp -rf $OP_NAME/op_host/* CustomOp/op_host/
cp -rf $OP_NAME/op_kernel/* CustomOp/op_kernel/
# Delete the tiling header generated by msopgen, ATVC uses its own tiling definition
rm -rf CustomOp/op_kernel/*_tiling.h
